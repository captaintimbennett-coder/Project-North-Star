  ...
  return <form className="application-form" ref={formRef} onSubmit={submit}>
    ...
    <section className="application-form-section" aria-labelledby="model-work-title">
      ...
      <div className="application-form-grid">
        ...
        <Field name="alternateModelList" label="Alternate Featured Artist list" required error={errors.alternateModelList} description="If all Featured Artist positions are filled, would you like to be considered as an alternate if an opening becomes available? Alternate artists may be invited if another artist cancels or if additional opportunities become available before the event."><select className="application-input" id="alternateModelList" name="alternateModelList" required aria-invalid={!!errors.alternateModelList} aria-describedby={by("alternateModelList", true, errors.alternateModelList)}><option value="">Select one</option>{content.alternateModelList.map(o => <option key={o.value} value={o.value}>{o.label}</option>)}</select></Field>
    ...
    <section className="application-form-section" aria-labelledby="model-materials-title">
      ...
      <div className="application-form-grid application-form-grid--single">
        ...
        <Field name="shortBiography" label="Short biography" description="Optional. You may introduce your experience now or complete this after acceptance." error={errors.shortBiography}><textarea className="application-input application-textarea" id="shortBiography" name="shortBiography" rows={6} aria-invalid={!!errors.shortBiography} /></Field>
    ...
    <section className="application-form-section application-form-section--consent" aria-labelledby="model-consent-title">
      ...
      <div className="application-submit"><p>Your application remains private during review. Public publication occurs only after acceptance, Tim’s approval, and the publication permission above. You may complete optional profile details after acceptance.</p><Button type="submit" variant="primary" disabled={submitting}>{submitting ? "Submitting…" : content.submitLabel}</Button></div>
    </section>
  </form>;
}
